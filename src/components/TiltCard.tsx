...
export const TiltCard = ({
    ...
    return (
        <div
            ref={containerRef}
            className={`perspective-1000 w-full h-[360px] overflow-hidden ${className} select-none touch-pan-y`}
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        {/* Selection Status Indicator (Tiny dot on front) */}
                        {isSelected && (
                    ...
                    >
                        ...
                        <motion.div
                            className="absolute inset-0 pointer-events-none"
                            style={{
                                background: useMotionTemplate`radial-gradient(600px circle at ${glareX} ${glareY}, rgba(34, 197, 94, 0.3), transparent 80%)`
                            }}
                        />
                        ...
                        {/* Checkmark - absolutely positioned to not affect layout */}
